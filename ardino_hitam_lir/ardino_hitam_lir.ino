/*
  ...
  This script will output the sensed temperature of the LM35 from 20 to 32Â°C by LEDs.
...
void loop()
{
  ...
  temperature = temperature*0.488;        // correcting to Â°C 
  ...
  Serial.print(temperature);Serial.println(" Â°C");  // send the temperarue to the serial monitor
